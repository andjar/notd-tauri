// Example: Basic usage of the outliner-core library
// 
// This demonstrates creating notes, outline nodes, tags, links, and tasks.
...
fn main() -> anyhow::Result<()> {
    println!("Outliner Core Library - Example Usage\n");
    
    // ========== Create Database ==========
    println!("1. Creating database...");
    let db = Database::new("example.db");
    let conn = db.create()?;
